...
var ENGINE_PATH = 'http://localhost:8000/wasm-builder/pdftex.wasm/neopdftex.js';
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, _) {
                                ...
                                _this.latexWorker.postMessage({ 'cmd': 'compilelatex', 'mode': '-interaction=nonstopmode' });
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                _this.latexWorker.onmessage = function (ev) {
                                    ...
                                    if (result === 'ok') {
                                        ...
                                        downloadLink.href = formatURL_1;
                                        downloadLink.download = 'neopdftex.fmt';  // Set the desired file name
