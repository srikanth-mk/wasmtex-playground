...
const char *ptexbanner = " (neopdfTeX 0.1.0)";
const char *DEFAULT_FMT_NAME = " neopdftex.fmt";
const char *DEFAULT_DUMP_NAME = "neopdftex";
string versionstring = " (neopdfTeX 0.1.0)";
int exit_code;
jmp_buf jmpenv;
...
int main(int argc, char **argv) {
  ...
  if (strlen(bootstrapcmd) == 0) {
    fprintf(stderr, "Usage: neo foo.tex\n");
    return -1;
  }
...
int main(int argc, char **argv) {
    printf("neopdfTeX Engine Loaded\n");
}
